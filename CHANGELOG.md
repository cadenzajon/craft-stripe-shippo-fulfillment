...
- Paid-order admin emails are claimed atomically per Checkout Session, preventing duplicates from concurrent or retried webhooks while allowing failed or abandoned sends to retry.
